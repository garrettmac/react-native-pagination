...
let dotComponent=(<Animated.Image
  source={{uri:`https://robohash.org/${_.get(o,"item.name","default")}?size=350x350&set=set1`}}
  style={{
...
return (<Dot
  ...
  style={{margin:1,marginBottom:5,backgroundColor:"transparent",justifyContent: "center",alignItems: "center",}}/>)
}
      ...
      return (<View style={[s.container]}>
        ...
        {this.state.activeItem &&
          <TouchableOpacity onPress={()=>this.setItemAsActive(o)} style={[s.renderItem,s.activeItem]} >
            <Image resizeMode="center" style={s.image} source={{uri:`https://robohash.org/r${_.get(this.state.activeItem,"name","default")}?size=350x350&set=set1`}}/>
