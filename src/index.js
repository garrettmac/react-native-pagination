...
// console.log("fillIndexes: data: ",data);
  return {index:_.get(data,`[${o}].index`,i),key:_.get(data,`[${o}].id`,i),item:_.get(data,`[${o}]`,{}),isViewable:false}
})
...
let ALL_DOTS_INDEXES=ALL_DOTS.map(i=>i.isViewable)
    ...
    let ADBY=`%c all visible dots:              ${ALL_DOTS_BY_INDEX} \n`
...
let horizontalStyle={backgroundColor:"rgba(100,0,0,.5)",width,position:"absolute", right:0,left:0,bottom:7,padding:10,flex:1,justifyContent:"center",alignItems:'center',flexDirection:"row",}
